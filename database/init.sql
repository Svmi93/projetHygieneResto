...
DROP TABLE IF EXISTS equipments; -- <--- ADDED DROP for equipments
...
-- Create equipments table -- <--- NEW TABLE ADDED
CREATE TABLE IF NOT EXISTS equipments (
    id INT AUTO_INCREMENT PRIMARY KEY,
    admin_client_id INT NOT NULL,
    name VARCHAR(255) NOT NULL,
    type VARCHAR(100) NOT NULL, -- e.g., 'Frigo', 'Congélateur', 'Chambre froide'
    temperature_type ENUM('positive', 'negative') NOT NULL,
    min_temp DECIMAL(5, 2), -- Optional: minimum recommended temperature
    max_temp DECIMAL(5, 2), -- Optional: maximum recommended temperature
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE temperature_records (
    ...
    temperature_type ENUM('positive', 'negative') NOT NULL DEFAULT 'positive', -- <--- ADDED this column
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
