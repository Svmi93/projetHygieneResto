...
import LoginPage from '../pages/LoginPage'; // Chemin corrigé pour LoginPage
import RegisterAdminClientPage from '../pages/RegisterAdminClientPage'; // Chemin corrigé pour RegisterAdminClientPage
...
function HomePage({ showLoginForm, showRegisterForm, onAdminClientRegistered, onCancelLogin, onCancelRegister }) {
  ...
  return (
    <div className="home-page-container">
      ...
      {showLoginForm ? (
        <LoginPage onCancel={onCancelLogin} />
      ) : /* Sinon, affiche le formulaire d'inscription si showRegisterForm est vrai */
      showRegisterForm ? (
        <RegisterAdminClientPage onAdminClientRegistered={onAdminClientRegistered} onCancel={onCancelRegister} />
      ) : (
        // Sinon (aucun formulaire n'est actif), affiche le contenu statique de la page d'accueil
        <>
